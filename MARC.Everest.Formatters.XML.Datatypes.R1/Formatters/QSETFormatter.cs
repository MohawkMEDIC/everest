...
namespace MARC.Everest.Formatters.XML.Datatypes.R1.Formatters
{
    ...
    public class QSETFormatter : IDatatypeFormatter
    {
        ...
        public void Graph(System.Xml.XmlWriter s, object o, DatatypeFormatterGraphResult result)
        {
            ...
            result.AddResultDetail(new NotImplementedResultDetail(ResultDetailType.Warning, "QSET cannot be graphed by the R1 formatter directly, processing as SXPR", s.ToString(), null));
