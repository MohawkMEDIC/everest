...
namespace MARC.Everest.Formatters.XML.Datatypes.R1.Formatters
{
    ...
    /// </summary>
    public class QSPFormatter : IDatatypeFormatter
    {
        ...
        { 
            ...
            result.AddResultDetail(new NotImplementedResultDetail(ResultDetailType.Warning, "QSP cannot be graphed by the R1 formatter directly, processing as SXPR", s.ToString(), null));
        ...
        public object Parse(System.Xml.XmlReader s, DatatypeFormatterParseResult result)
        {
            ...
            result.AddResultDetail(new NotImplementedResultDetail(ResultDetailType.Warning, "QSP cannot be parsed by the R1 formatter directly, processing as SXPR", s.ToString(), null));
            SXPRFormatter formatter = new SXPRFormatter();
            formatter.Host = this.Host;
            formatter.GenericArguments = this.GenericArguments;
