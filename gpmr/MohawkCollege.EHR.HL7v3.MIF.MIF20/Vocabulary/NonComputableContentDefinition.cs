...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF20.Vocabulary
{
    ...
    /// </summary>
    [XmlType(TypeName = "NonComputableContentDefinition", Namespace = "urn:hl7-org:v3/mif2")]
    public class NonComputableContentDefinition
    {
        /// <summary>
        /// Text of the non computable content definition
        /// </summary>
        ...
        public List<ComplexMarkupWithLanguage> Text { get; set; }
    }
}