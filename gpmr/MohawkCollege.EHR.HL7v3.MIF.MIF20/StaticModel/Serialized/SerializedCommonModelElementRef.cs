...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF20.StaticModel.Serialized
{
    ...
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1501:AvoidExcessiveInheritance"), XmlType(TypeName = "SerializedCommonModelElementRef", Namespace = "urn:hl7-org:v3/mif2")]
    public class SerializedCommonModelElementRef : CommonModelElementRefBase
    {
        private List<SerializedCommonModelElementGeneralization> generalizationParent;
        ...
        public List<SerializedCommonModelElementGeneralization> GeneralizationParent
        {
