...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF20.StaticModel.Flat
{
    ...
    /// </summary>
    [XmlType(TypeName = "CommonModelElementGeneralization", Namespace = "urn:hl7-org:v3/mif2")]
    public class CommonModelElementGeneralization : CommonModelElementGeneralizationBase
    {
        ...
        /// <summary>
        /// Identifies the classes that are to be bound to a parameteratized common model element
        /// </summary>
