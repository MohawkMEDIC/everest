...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF20
{
    ...
    /// </remarks>
    [XmlType(TypeName = "SubjectAreaPackage", Namespace = "urn:hl7-org:v3/mif2")]
    public class SubjectAreaPackage : PackageBase
    {
        ...
        /// <summary>
        /// Describes the ballot or other approval status and information associated
        /// with the subject area.
        /// </summary>
        [XmlElement("approvalInfo")]
        public ApprovalInfo ApprovalInfo
        {
            get { return approvalInfo; }
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists"), XmlElement(ElementName = "containedClass")]
