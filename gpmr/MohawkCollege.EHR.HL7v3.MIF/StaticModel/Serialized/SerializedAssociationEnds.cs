...
{
    /// <summary>
    /// Handles assocations that can be traversed or not
    /// </summary>
    [XmlType(TypeName = "SerializedAssociationEnds", Namespace = "urn:hl7-org:v3/mif")]
    public class SerializedAssociationEnds
    {

        private Relationship content;

        /// <summary>
        /// Content of the association end
        /// </summary>
        [XmlElement(ElementName = "traversableConnection", Type = typeof(AssociationEndWithClassRef))]
