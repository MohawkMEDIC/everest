...
namespace MARC.Everest.Formatters.XML.ITS1
{
    ...
    /// </list>
    /// <para>
    /// Furthermore, this formatter can be optimized during initialization using the <see cref="M:BuildCache"/> and 
    /// <see cref="M:AddFormatterAssembly"/> methods. These methods force the formatter to "learn" structure prior
    /// actually serializing them. In the case of <see cref="M:AddFormatterAssembly"/>, it is possible to load an 
    ...
    public class XmlIts1Formatter : IXmlStructureFormatter, ICloneable, ICodeDomStructureFormatter, IValidatingStructureFormatter, IDisposable
    {
        ...
        /// <seealso cref="M:Graph(System.Xml.XmlWriter,MARC.Everest.Interfaces.IGraphable)"/>
        ...
        /// <seealso cref="M:Graph(System.IO.Stream,System.Reflection.Assembly)"/> method when more than one RMIM assembly
        /// is loaded in memory.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>This method differs from the <seealso cref="M:Parse(System.IO.Stream)"/> method in that it
        ...
        /// <returns>A <see cref="MARC.Everest.Formatters.XML.ITS1.Its1FormatterParseResult"/> containing the results of the parse</returns>
        /// <remarks>
        /// <para>This method differs from the <seealso cref="M:Parse(System.Xml.XmlReader)"/> method in that it
        /// will only look within the specified assembly for a suitable class to populate.</para>
        /// <para>
        /// This method will not check the current learned type repository for a class to serialize (ie: it will always 
        /// check the assembly regardless of what has been formatted prior)
