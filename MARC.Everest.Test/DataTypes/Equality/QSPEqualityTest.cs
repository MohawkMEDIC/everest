...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>"/> is not equal to another
/// <list type="table">
...
/// </list>
[TestMethod]
public void QSPNotEqualsOriginalTextTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
...
/// </list>
[TestMethod]
public void QSPNotEqualsNullFlavorTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsUpdateModeTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsFlavorTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsValidTimeLowTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsValidTimeHighTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsControlActRootTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void QSPNotEqualsControlActExtTest() {
MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>();
aValue.OriginalText = new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0");
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.QSP<MARC.Everest.DataTypes.INT>"/> is  equal to another
/// <list type="table">
/// <listheader><term>Property</term><description>Comments</description></listheader>
/// <item><term>OriginalText</term><description>A=new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0"),B=new MARC.Everest.DataTypes.ED(new System.Byte[] { 0 },"0")</description></item>
/// <item><term>NullFlavor</term><description>A=new MARC.Everest.DataTypes.CS&lt;MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown),B=new MARC.Everest.DataTypes.CS&lt;MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown)</description></item>
