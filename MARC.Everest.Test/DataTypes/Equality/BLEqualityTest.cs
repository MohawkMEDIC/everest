...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.BL"/> is not equal to another
/// <list type="table">
/// <listheader><term>Property</term><description>Comments</description></listheader>
/// <item><term>Value</term><description>A=false,B=true</description></item>
...
/// </list>
[TestMethod]
public void BLNotEqualsValueTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
...
/// <list type="table">
/// <listheader><term>Property</term><description>Comments</description></listheader>
/// <item><term>Value</term><description>A=false,B=false</description></item>
...
/// </list>
[TestMethod]
public void BLNotEqualsNullFlavorTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsUpdateModeTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsFlavorTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsValidTimeLowTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsValidTimeHighTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsControlActRootTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// </list>
[TestMethod]
public void BLNotEqualsControlActExtTest() {
MARC.Everest.DataTypes.BL aValue = new MARC.Everest.DataTypes.BL(), bValue = new MARC.Everest.DataTypes.BL();
aValue.Value = false;
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
aValue.UpdateMode = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.UpdateMode>(MARC.Everest.DataTypes.UpdateMode.Add);
...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.BL"/> is  equal to another
/// <list type="table">
/// <listheader><term>Property</term><description>Comments</description></listheader>
/// <item><term>Value</term><description>A=false,B=false</description></item>
/// <item><term>NullFlavor</term><description>A=new MARC.Everest.DataTypes.CS&lt;MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown),B=new MARC.Everest.DataTypes.CS&lt;MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown)</description></item>
