...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>"/> is not equal to another
/// <list type="table">
...
/// </list>
[TestMethod]
public void UVPNotEqualsValueTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsNullFlavorTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsUpdateModeTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsFlavorTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsValidTimeLowTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsValidTimeHighTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsControlActRootTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// </list>
[TestMethod]
public void UVPNotEqualsControlActExtTest() {
MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT> aValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>(), bValue = new MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>();
aValue.Probability = (decimal)0.0f;
aValue.Value = new MARC.Everest.DataTypes.INT(0);
aValue.NullFlavor = new MARC.Everest.DataTypes.CS<MARC.Everest.DataTypes.NullFlavor>(MARC.Everest.DataTypes.NullFlavor.AskedUnknown);
...
/// <summary>
/// Determine if one <see cref="T:MARC.Everest.DataTypes.UVP<MARC.Everest.DataTypes.INT>"/> is  equal to another
/// <list type="table">
/// <listheader><term>Property</term><description>Comments</description></listheader>
/// <item><term>Probability</term><description>A=0.0f,B=0.0f</description></item>
/// <item><term>Value</term><description>A=new MARC.Everest.DataTypes.INT(0),B=new MARC.Everest.DataTypes.INT(0)</description></item>
