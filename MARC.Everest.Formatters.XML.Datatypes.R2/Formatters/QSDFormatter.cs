...
namespace MARC.Everest.Formatters.XML.Datatypes.R2.Formatters
{
    ...
    public class QSDFormatter : IDatatypeFormatter
    {
        ...
        public void Graph(System.Xml.XmlWriter s, object o, DatatypeR2FormatterGraphResult result)
        {
            ...
            object minuendValue = o.GetType().GetProperty("Minuend").GetValue(o, null),
                subtrahendValue = o.GetType().GetProperty("Subtrahend").GetValue(o, null);
        ...
        public List<System.Reflection.PropertyInfo> GetSupportedProperties()
        {
            ...
            retVal.AddRange(typeof(QSD<>).GetProperties(BindingFlags.DeclaredOnly | BindingFlags.Instance | BindingFlags.Public));
