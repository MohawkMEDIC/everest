...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF10.Interfaces
{
    ...
    /// </summary>
    [XmlType(TypeName = "CommonModelElement", Namespace = "urn:hl7-org:v3/mif")]
    public class CommonModelElement : ClassifierBase
    {
        ...
        /// </summary>
        [XmlElement("specializationChildEntryClass")]
        public SpecializationClass SpecializationChildEntryClass
        {
        ...
        /// <summary>
        /// The modelId of the model that implements the common model element
        /// </summary>
        [XmlElement("specializationChildStaticModel")]
        public PackageRef SpecializationChildStaticModel
        {
