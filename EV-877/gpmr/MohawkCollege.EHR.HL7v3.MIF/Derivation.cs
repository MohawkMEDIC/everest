...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF10
{
    ...
    /// </summary>
    [XmlType(TypeName = "Derivation", Namespace = "urn:hl7-org:v3/mif")]
    public class Derivation : Dependancy
    {
        ...
        public string AnnotationsReviewedBy
        {
        ...
        /// <summary>
        /// Indentifies whether the analysis of the derivation has included a review of changed annotations. This is false
