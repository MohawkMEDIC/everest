...
{
    /// <summary>
    /// A derivation stereotype to a transition
    /// </summary>
    [XmlType(TypeName = "TransitionDerivation", Namespace = "urn:hl7-org:v3/mif")]
    public class TransitionDerivation : ClassDerivation
    {
        ...
        /// <summary>
        /// The name of the correspondig state transition in the parent model
        /// </summary>
