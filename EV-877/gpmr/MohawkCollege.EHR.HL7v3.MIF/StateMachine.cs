...
namespace MohawkCollege.EHR.HL7v3.MIF.MIF10
{
    ...
    /// State machine
    /// </summary>
    [XmlType(TypeName = "StateMachine", Namespace = "urn:hl7-org:v3/mif")]
    public class StateMachine
    {
        ...
        /// is drawn from the list of states in the class' state engine)
        /// </summary>
        [XmlAttribute("supplierStateAttributeName")]
