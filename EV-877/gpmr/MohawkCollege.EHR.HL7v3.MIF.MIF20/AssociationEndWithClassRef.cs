...
{
    /// <summary>
    /// An AssociationEnd that points to a class
    /// </summary>
    [XmlType(TypeName = "AssociationEndWithClassRef", Namespace = "urn:hl7-org:v3/mif2")]
    public class AssociationEndWithClassRef : AssociationEndBase
    {
