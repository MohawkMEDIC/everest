...
{
    /// <summary>
    /// Restricts the values of a coding strength type
    /// </summary>
    [XmlType(TypeName = "CodingStrengthKind", Namespace = "urn:hl7-org:v3/mif2")]
    public enum CodingStrengthKind
    {
        ...
        CWE,
        /// <summary>
        /// Identifies no content has been defined in this MIF
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "NCD")]
        [XmlEnum("No content defined.")]
        NCD
    }
}