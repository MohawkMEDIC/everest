...
{
    /// <summary>
    /// Identifies a class that specialize the participant class for this association end
    /// </summary>
    [XmlType(TypeName = "AssociationEndSpecialization", Namespace = "urn:hl7-org:v3/mif2")]
