...
namespace MARC.Everest.Formatters.XML.Datatypes.R1.Formatters
{
    ...
    public class QSIFormatter : IDatatypeFormatter
    {
        ...
        public void Graph(System.Xml.XmlWriter s, object o, DatatypeFormatterGraphResult result)
        {
            ...
            result.AddResultDetail(new NotImplementedResultDetail(ResultDetailType.Warning, "QSI cannot be graphed by the R1 formatter directly, processing as SXPR", s.ToString(), null));
        ...
        {
            result.AddResultDetail(new NotImplementedResultDetail(ResultDetailType.Warning, "QSI cannot be parsed by the R1 formatter directly, processing as SXPR", s.ToString(), null));
            SXPRFormatter formatter = new SXPRFormatter();
            formatter.Host = this.Host;
            formatter.GenericArguments = this.GenericArguments;
